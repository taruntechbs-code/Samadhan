...
export const GrievanceSubmitModal: React.FC<GrievanceSubmitModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <Card variant="standard" style={{ padding: '2rem 1.75rem', position: 'relative' }}>
          {/* Close Button */}
          <button
            type="button"
          ...
          {!submittedRecord ? (
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <div>
                <Badge type="primary" style={{ marginBottom: '0.5rem' }}>
                  <span>Final Step &bull; Citizen Redressal Dispatch</span>
                </Badge>
              ...
              <div className="input-container">
                <label style={{ fontSize: '0.8125rem', fontWeight: 500, color: 'var(--md-sys-color-on-surface-variant)' }}>
                  Mobile Number (for SMS Tracking &amp; OTP updates) *
                </label>
                <input
                  type="tel"
                  required
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem', marginTop: '0.5rem' }}>
                ...
                <Button type="submit" variant="filled" disabled={isSubmitting}>
                  <span>{isSubmitting ? 'Submitting to Portal...' : 'Lodge Grievance Now'}</span>
                  <ArrowRight size={16} />
                </Button>
              </div>
            </form>
            ...
            <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', padding: '1rem 0' }}>
              ...
              >
                ...
                <div style={{ fontSize: '1.75rem', fontWeight: 800, color: 'var(--md-sys-color-primary)', letterSpacing: '0.05em', marginTop: '0.25rem' }}>
                  {submittedRecord.id}
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '0.75rem', width: '100%', justifyContent: 'center', flexWrap: 'wrap' }}>
                ...
                >
                  <FileCheck size={16} />
                  <span>Track This Grievance Now</span>
                </Button>
                <Button
                  variant="tonal"
                  onClick={() => {
                ...
                >
                  <span>View in My Grievances</span>
                </Button>
              </div>
            </div>
          )}
